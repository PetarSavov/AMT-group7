...
function talkBubble (player, item){
    ...
    game.time.events.add(Phaser.Timer.SECOND * 12, removeBubble, this);
        ...
        game.time.events.add(Phaser.Timer.SECOND * 9, newSpaceship, this);
    }
...
function newSpaceship(){
    ...
    game.time.events.add(Phaser.Timer.SECOND*3, spaceshipLiftOff, this);
}
...
function spaceshipLiftOff(){
    removeBubble();
        ...
        var launch = game.add.audio('launch');
        launch.play();
