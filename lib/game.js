...
function preload() {
    ...
    game.load.spritesheet('bubble', 'assets/images/bubble-talk-sprite.png', 90, 55);
    ...
    game.load.image('portal', 'assets/images/teleport.png');
  //  game.load.image('bubble', 'assets/images/bubble-talk.png');
...
function createFromPortal(x,y){
    ...
    teleportA=teleportFrom.create(x,y,'portal');
    teleportA.width = 60;
    teleportA.height = 60; 
}
...
function createToPortal(x,y){
    ...
    teleportB = teleportTo.create(x, y, 'portal');
    teleportB.width=60;
    teleportB.height=60;
}
...
function createBrokenShip(x, y){
    ...
    var temp = brokenShip.create(x, y, 'brokenShip');
}
...
function createTalkBubble(){
    textBubble = game.add.sprite(player.x + 500, player.y - 10, 'bubble');
    textBubble.fixedToCamera = true;
    textBubble.visible = false;
    textBubble.animations.add('talk', [0, 0, 1, 1, 2, 2, 3, 3], 1, false);
...
function talkBubble (player, item){
    ...
    game.time.events.add(Phaser.Timer.SECOND * 8, removeBubble, this);
    }
     count++;
}
